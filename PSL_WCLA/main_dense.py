...
from cnn_tcn import CNN_LSTM  # OPTION 0
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        out_dir = os.path.abspath(os.path.join(os.path.curdir, "human_dense", timestamp))
        print("Writing to {}\n".format(out_dir))
        ...
        checkpoint_dir = os.path.abspath(os.path.join("human_dense", "checkpoints"))
