...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        checkpoint_dir = os.path.abspath(os.path.join("run", "checkpoints"))
        ...
        if istrain:
            ...
            print(accuracy)  # dev_step(x_dev, y_dev, writer=dev_summary_writer)
...
print(classification_report(y_test, outputs, labels=None, target_names=None, sample_weight=None, digits=2))
...
classes = ['Cell.membrane', 'Cytoplasm', 'Endoplasmic', 'Extracellular', "Golgi.apparatus", "Lysosome", "Mitochondrion",
