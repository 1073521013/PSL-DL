...
from cnn_bn import CNN_LSTM   #OPTION 0
...
#            model = LSTM(x_train.shape[1],y_train.shape[1],len(vocab_processor.vocabulary_),embedding_dim)
        ...
        out_dir = os.path.abspath(os.path.join(os.path.curdir, "runs_bn", timestamp))
        print("Writing to {}\n".format(out_dir))
        ...
        checkpoint_dir = os.path.abspath(os.path.join("runs_bn", "checkpoints"))
