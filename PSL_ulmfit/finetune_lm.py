...
def train_lm(dir_path, pretrain_path, cuda_id=0, cl=20, pretrain_id='', lm_id='pretrain_', bs=64,
    ...
    if preload and startat == 0:
        ...
        if bpe:
            ...
            itos2 = pickle.load(open(pretrain_path / 'tmp' / f'itos{pretrain_id}.pkl', 'rb'))
...
if __name__ == '__main__': 
    train_lm('data/wiki/ch/','data/wiki/ch/')
