...
def train_clas(dir_path, cuda_id, lm_id='pretrain_', clas_id='pretrain_', bs=64, cl=15, backwards=False, startat=0, unfreeze=True,
    ...
    trn_lbls = trn_lbls.reshape((trn_lbls.shape[0],1))
    val_lbls = val_lbls.reshape((val_lbls.shape[0],1))
    print(trn_lbls.shape)
